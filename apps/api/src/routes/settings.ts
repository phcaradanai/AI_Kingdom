...
const BOOLEAN_SETTING_KEYS = ["AUTO_SAVE_MEMORY", "AUTO_GENERATE_REPORTS", "AUTO_ASSIGN_WORK_ORDERS", "ROUTING_DEBUG_MODE", "ALLOW_PRODUCTION_FALLBACK_IN_SANDBOX", "ALLOW_RUNNER_BRANCH_PUSH", "ALLOW_RUNNER_PR_CREATE", "LIVING_LOOP_ENABLED", "LIVING_LOOP_AUTO_CREATE_VALIDATION_JOBS", "LIVING_LOOP_AUTO_SANDBOX_PATCH", "LIVING_LOOP_ALLOW_BRANCH_PUSH", "LIVING_LOOP_ALLOW_PR_CREATE", "LIVING_LOOP_ALLOW_PAID_PROVIDERS"];
