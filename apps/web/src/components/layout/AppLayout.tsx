...
export function AppLayout() {
  ...
  return (
    <div className="min-h-screen">
      <aside className="fixed inset-y-0 left-0 hidden w-72 border-r border-border bg-background/80 p-5 backdrop-blur-xl lg:block">
        ...
        <div className="absolute bottom-5 left-5 right-5 rounded-lg border border-border bg-muted/40 p-4">
